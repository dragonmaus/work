...
#define STRERR2(r,se,a,b) { se.who = 0; se.x = a; se.y = b; se.z = 0; return r; }
#define STRERR3(r,se,a,b,c) { se.who = 0; se.x = a; se.y = b; se.z = c; return r; }

#define STRERR_SYS(r,se,a) { se.who = &strerr_sys; se.x = a; se.y = 0; se.z = 0; return r; }
#define STRERR_SYS2(r,se,a,b) { se.who = &strerr_sys; se.x = a; se.y = b; se.z = 0; return r; }
